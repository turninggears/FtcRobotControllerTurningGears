...
@Config
public class JeremyPracticeCode extends OpMode {

    public static double maxSpeed = 1.0;  // make this slower for outreaches
    // This declares the four motors needed
    public static int armUpPosition = 500;
    public static int armDownPosition = 40;
    //added this to set up arm position
    ...
    DcMotor armMotor;
    // this was added to declare armMotor
