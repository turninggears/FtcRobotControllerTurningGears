...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1758.18; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2897; // x position of the perpendicular encoder (in tick units)
    }
